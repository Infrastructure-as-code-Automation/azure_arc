...
Write-Host
Write-Host "debug: Successfully deployed HCIBox infrastructure." -ForegroundColor Green
Write-Host "debug: Infrastructure deployment time was $($timeSpan.Hours):$($timeSpan.Minutes) (hh:mm)." -ForegroundColor Green
